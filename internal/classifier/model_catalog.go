...
var EmbeddedCatalog = []CatalogEntry{
	// Wildlife models (multi-taxa classifiers)
	{
		ID:              "birdnet-v3.0",
		Name:            "BirdNET v3.0",
		Description:     "Global wildlife classifier using BirdNET v3.0 architecture (Developer Preview — 11,000 species, 32 kHz, 5s clips). Can run alongside v2.4 for comparison.",
		...
		Hidden:          false,
		RequiresONNX:    true,
		UpstreamURL:     "https://github.com/birdnet-team/birdnet-V3.0-dev",
