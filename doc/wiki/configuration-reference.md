...
BSG regional bird model configuration
...
Global model enablement and management
...
Low-memory mode override (auto/on/off) for constrained systems
...
| `notification.push.min_confidence_threshold` | number | 0.0-1.0, 0 = disabled |
...
Alerting rules engine settings
